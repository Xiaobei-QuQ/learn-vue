      ...
      <div class="checkout-addr">
        ...
        <div class="addr-list-wrap">
          <div class="addr-list">
            <ul>
              <li v-for="(item,index) in filterAddress" v-bind:class="{'check':index==currentIndex}" @click="currentIndex=index">
                ...
                <div class="addr-opration addr-edit" @click="editFlag=true">
                  <a href="javascript:;" class="addr-edit-btn">
                    <svg class="icon icon-edit"><use xlink:href="#icon-edit"></use></svg>
                  </a>
                </div>
                <div class="addr-opration addr-del" @click="delFlag=true;pindex=index">
              ...
              <li class="addr-new" @click="editFlag=true">
          ...
          <div class="shipping-addr-more">
            <a class="addr-more-btn up-down-btn" href="javascript:" @click="showOrHide(limitNumber)">
              more
              <i class="i-up-down">
        ...
        <div class="shipping-method-wrap">
          <div class="shipping-method">
            <ul>
              <li v-bind:class="{'check':shoppingMethod==1}" @click="shoppingMethod=1">
                <div class="name">标准配送</div>
                <div class="price">Free</div>
              </li>
              <li v-bind:class="{'check':shoppingMethod==2}" @click="shoppingMethod=2">
        ...
        <div class="md-modal modal-msg md-modal-transition" id="showModalw"  v-bind:class="{'md-show':editFlag}">
          <div class="md-modal-inner">
            <div class="md-top">
              <button class="md-close"   @click="editFlag=false">关闭</button>
            </div>
            <div class="md-content">
              <div class="confirm-tips">
              ...
              <div class="btn-wrap col-2">
                <button class="btn btn--s" id="btnModalConfirms"   @click="addProduct">保存</button>
                <button class="btn btn--s btn--red" id="btnModalCancels"   @click="editFlag=false">取消</button>
              </div>
            </div>
          </div>
        </div>
